...
This machine is **HOKUSAI BigWaterfall2 (HBW2)**, the RIKEN R-CCS CPU-first
Slurm cluster. The official documentation you should build from is in
[`docs/`](docs/). Once you have implemented the port, record everything
specific to *this* machine — HBW2's cluster facts, any decisions you made
under uncertainty, and the repo map — in an `AGENTS.md` you create, the way
the canonical guide describes.
