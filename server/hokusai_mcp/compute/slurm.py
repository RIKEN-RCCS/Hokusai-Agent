"""SlurmBackend for HOKUSAI BigWaterfall2."""
...
class SlurmBackend(SchedulerBackend):
    ...
    def _header(self, spec: JobSpec) -> list[str]:
        ...
        # GPUs are optional on HBW2 (GPU server only); `gpus` → --gpus takes precedence
        ...
        # HBW2 requires --account; fall back to the config default.
